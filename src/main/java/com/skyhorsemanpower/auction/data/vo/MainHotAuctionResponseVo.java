...
@ToString
@NoArgsConstructor
public class MainHotAuctionResponseVo {
    ...
    @Builder
    public MainHotAuctionResponseVo(String auctionUuid, String title, String category, int minimumBiddingPrice, LocalDateTime createdAt, LocalDateTime endedAt, String handle, String thumbnail, String content) {
    ...
    public MainHotAuctionResponseVo toVo(ReadOnlyAuction readOnlyAuction, String thumbnail, String handle) {
        return MainHotAuctionResponseVo.builder()
