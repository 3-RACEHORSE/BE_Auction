...
@ToString
@NoArgsConstructor
public class MainHighBiddingPriceAuctionResponseVo {
    ...
    @Builder
    public MainHighBiddingPriceAuctionResponseVo(String auctionUuid, String title, String category, int minimumBiddingPrice, LocalDateTime createdAt, LocalDateTime endedAt, String handle, String thumbnail, String content) {
    ...
    public MainHighBiddingPriceAuctionResponseVo toVo(ReadOnlyAuction readOnlyAuction, String thumbnail, String handle) {
        return MainHighBiddingPriceAuctionResponseVo.builder()
